...
function Header() {
  ...
  function findTitle() {
    ...
    if (paths[1] === "") {
      ...
      title =
        id_mast.toUpperCase() +
        " | " +
        main[id_cat - 1].weapons[id_weap - 1].name.toUpperCase();
    }
    return title;
  }
  ...
  return (
    <div
      className="tracker_header"
      onMouseEnter={() => setShow(true)}
      onMouseLeave={() => setShow(false)}
    >
      {isAuth && (
        <div
          className="tracker_header_menu"
      ...
      {isAuth && (
        <div className="tracker_header_title">
          ...
          {paths[1] === "weapon" && (
            <div
              className="tracker_header_title_check"
              onClick={() => dispatchWeapon()}
      ...
      {isAuth && (
        <div
          className="tracker_header_settings"
